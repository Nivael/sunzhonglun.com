...
| v1.1 | 公众号文章迁移（实际 77 篇，见 §5） | 🔨 76/77，1 篇待补 + 全量校对 |
...
（总数修正：实际未删除文章 **77 篇**——后台"93"为发表记录数，含已删文章与无文章的群发）

- [ ] 77 篇全部在新站正常渲染，图片全部本地化，无任何 `mp.weixin.qq.com` 资源依赖
      （2026-07-13：76 篇已迁，idx 31《银河之一日·下》被微信风控，待补）
- [ ] 抽查 10 篇与公众号原文逐段比对，无内容丢失（待用户校对）
